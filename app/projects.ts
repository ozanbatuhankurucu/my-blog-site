...
export const PROJECTS: Project[] = [
	{
		...
		features: [
			...
			{ text: 'Persistent content — Your markdown is saved to localStorage automatically' },
			...
			{ text: 'Drag-and-drop import — Drop a .md, .markdown, or .txt file onto the editor to load it' },
			...
			{ text: 'Keyboard shortcuts — Ctrl+S to download, Ctrl+Shift+C to copy HTML, Escape to exit fullscreen' },
		],
