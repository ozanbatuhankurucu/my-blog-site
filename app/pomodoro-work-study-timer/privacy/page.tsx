    ...
    <article className="container max-w-2xl py-16 md:py-24">
      <header className="mb-10">
        ...
        <p className="text-text-secondary text-lg leading-relaxed mb-2">
          <strong className="text-text-primary">{PULSE_APP_NAME}</strong> — menu bar Pomodoro timer for Mac
        </p>
        <p className="text-text-muted text-sm">Last updated: August 30, 2026</p>
      </header>

      <div className="space-y-10 text-text-secondary leading-relaxed">
        <section>
          <h2 className="font-mono text-xl font-medium text-text-primary mb-4">Summary</h2>
          <p>{PULSE_APP_NAME} does not collect, store, or transmit any personal data.</p>
        </section>

        <section>
          <h2 className="font-mono text-xl font-medium text-text-primary mb-4">Data collection</h2>
          <p className="mb-4">{PULSE_APP_NAME} does not collect any information from you. The app:</p>
        ...
        <section>
          ...
          <p>
            If you enable Launch at Login in Settings, {PULSE_APP_NAME} uses macOS system APIs to register as a login
        ...
        <section>
          ...
          <p>{PULSE_APP_NAME} does not collect personal information from anyone, including children.</p>
        </section>
