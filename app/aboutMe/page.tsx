      ...
      <div className='max-w-[1250px] mx-auto py-24 px-4 md:px-0'>
        ...
        <div className=''>
          ...
          <p className='paragraph-2 text-black mt-5'>
            His professional journey reflects his natural curiosity and
            ambition. Ozan continually integrates the latest web development
            trends and tools into his work, driven by a desire to stay at the
            forefront of technological innovation.
          </p>
          <p className='paragraph-2 text-black mt-5'>
            Outside of his professional sphere, Ozan has a fervent love for
            exploration and adventure. He revels in the thrill of discovering
            new places, immersing himself in different cultures, and sampling
            exotic cuisines. These rich experiences have broadened his worldview
            and deepened his appreciation for diversity—a perspective he brings
          ...
          <p className='paragraph-2 text-black mt-5'>
            In essence, Ozan is more than just a Software Engineer; he is a
            global explorer, successfully merging his love for technology and
            travel into a fulfilling lifestyle.
          </p>
        </div>
      </div>
    </>
