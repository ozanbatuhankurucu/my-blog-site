...
export default function ProjectsContent({ inProgressProjects, completedProjects }: ProjectsContentProps) {
  const [selectedProject, setSelectedProject] = useState<Project | null>(null)

  const sortedCompletedProjects = [...completedProjects].sort(
    ...
    <>
      ...
      {completedProjects.length > 0 && (
        <section>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {renderProjects(sortedCompletedProjects)}
          </div>
        </section>
      )}
      ...
      <Drawer
        ...
        {selectedProject && (
          <div className='space-y-8'>
            ...
            {/* Description */}
            <div>
              <h3 className='font-mono text-sm font-medium text-text-muted uppercase tracking-wider mb-3'>About</h3>
